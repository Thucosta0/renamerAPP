...
class Danfe extends DaCommon
{
    ...
    protected function itens($x, $y, &$nInicio, $hmax, $pag = 0, $totpag = 0, $hCabecItens = 7)
    {
        ...
        foreach ($this->det as $d) {
            if ($i >= $nInicio) {
                ...
                $x += $w13;
                if (isset($ICMS)) {
                    $valor = !empty($ICMS->getElementsByTagName("pICMS")->item(0)->nodeValue)
                ...
                $x += $w14;
                if (isset($IPI)) {
                    $valor = !empty($IPI->getElementsByTagName("pIPI")->item(0)->nodeValue)
                ...
                if (!empty($veicProd)) {
                    ...
                    // linha entre itens
                    $this->pdf->line($oldX, $y + 30, $oldX + $w, $y + 30);
                    $y += 30;
                    $hUsado += 30;
                } else {
                    // linha entre itens
                    $this->pdf->line($oldX, $y, $oldX + $w, $y);
                }
                $y += $h;
                $i++;
    ...
    protected function rodape($x)
    {
        ...
        $texto = $this->powered ? "Designed By Thucosta © 2025" : '';
    ...
    protected function canhoto($x, $y)
    {
        ...
        if ($this->orientacao === 'P') {
            ...
            $this->pdf->line(22, $oldY, 22, $this->wPrint);
